...
function userMoviesApi(app) {
    ...
    router.post(
        ...
        async function (req, res, next) {
            ...
            try {
                const createdUserMovieId = await userMoviesService.addUserMovie(
                    {
                        userMovie,
                    }
                );
    ...
    router.delete(
        ...
        async function (req, res, next) {
            ...
            const { movieId, userId } = userMovie;

            try {
                const deletedUserMovieId = await userMoviesService.removeUserMovie(
                    movieId,
                    userId
                );
